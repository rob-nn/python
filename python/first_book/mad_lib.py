...
class Application(Frame):
	...
	def create_widgets(self):
		...
		Label(self, text="Enter informations for a new story").grid(row=0, column=0, columnspan=2, sticky=W)
		...
		# create a alabel and text entry for a verb
	...
	def tell_story(self):
		...
		story += person
		story += " had a nearly given up a life-long quest to find the Lost City of "
		story += noun.title()
