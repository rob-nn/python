...
print("but then eats 50 pounds of food, hou much does she weigh?")
...
print("your freiends split it evenly 4 ways, how much do you each throw in?")
input("Press the enter key to find out.")
print("19 / 4=", 19/4)

print("\nIf a group of 4 pirates finds a chest full of 107 gold coins, and")
print("they divide the booty envenly, how many whole coins does each get?")
input("Press the enter key to find out.")
print("107 // 4=", 107//4)
